...
const Servicios = () => {
    return (
        <div id='Servicios' className="servicios">
            ...
            <p>Crea y mantén tus sitios web y también cuida su rendimiento y capacidad de tráfico</p>
            ...
            <p>Diseño, construcción e implementación estándar de sus aplicaciones con documentación.</p>
            ...
            <p>Convierte lo que tienes en mente de un producto digital en realidad. Para cualquier plataforma que consideres.</p>
            </div>
        </div>
    )
}
