...
const Servicios = () => {
    return (
        <div id='Servicios' className="servicios">
            ...
            <p><spa className="mora">Crea y mantén</spa> tus sitios web y también cuida su rendimiento y capacidad de tráfico</p>
            <p><span>&mdash;&mdash;&mdash; Desarrollo de aplicaciones</span></p>
            ...
            <p><spa className="mora">Diseño, construcción e implementación</spa> estándar de sus aplicaciones con documentación.</p>
            <p><span>&mdash;&mdash;&mdash; Creatividad</span></p>
            ...
            <p><spa className="mora">Convierte</spa> lo que tienes en mente de un producto digital en realidad. Para cualquier plataforma que consideres.</p>
            </div>
        </div>
    )
}
